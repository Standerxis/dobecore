...
SettingsTab:Button("Salvar Configuração", function()
    ...
    local SaveData = {
        ...
        Keybinds = {
            MenuToggle = Library.ToggleKey.Name -- Salva a tecla atual do menu
        },
        -- AQUI ESTAVA O ERRO: Adicionando os dados dinâmicos
    ...
    if isfile(path) then
        ...
        if success and decoded then
            ...
            -- 2. Carregar Keybinds (O QUE FALTAVA)
            ...
            -- 3. Carregar Cores (O QUE FALTAVA)
            ...
            if decoded.ThemeData and decoded.ThemeData.AccentHex then
                ...
                -- Aqui você precisaria de uma função para atualizar o tema de tudo visualmente
                -- Library:UpdateTheme() (se você tiver essa função)
            end
